...
export class ProfitComponent implements OnInit {
  ...
  constructor(private popupService : PopupService, private profitService : ProfitService, private api : ApiService, private storageService : StorageService, private router : Router) { 
